...
namespace DataConfigurations.Migrations
{
    ...
    [Migration("20241209003348_InternationalDriving-License-Application")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.ApplicationModels.ApplicationFees", b =>
                {
                    b.Property<byte>("ApplicationTypeId")
                        .HasColumnType("tinyint");

                    b.Property<short>("ApplicationForId")
            ...
            modelBuilder.Entity("Models.ApplicationModels.ApplicationFor", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("Models.ApplicationModels.ApplicationType", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Models.ApplicationModels.InternationalDrivingLicenseApplication", b =>
                {
                    ...
                    b.ToTable("InternationalDrivingLicenseApplication");
                });
            ...
            modelBuilder.Entity("Models.LicenseModels.InternationalLicense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("InternationalDrivingLicenseApplication")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.LicenseModels.License", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.ApplicationModels.ApplicationFees", b =>
                {
                    b.HasOne("Models.ApplicationModels.ApplicationFor", "ApplicationFor")
                        .WithMany()
                        .HasForeignKey("ApplicationForId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.ApplicationModels.ApplicationType", "ApplicationType")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.ApplicationModels.InternationalDrivingLicenseApplication", b =>
                {
                    ...
                    b.HasOne("Models.LicenseModels.License", "License")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.ApplicationModels.LicenseApplication", b =>
                {
                    ...
                    b.HasOne("Models.ApplicationModels.ApplicationFees", "ApplicationFees")
            ...
            modelBuilder.Entity("Models.LicenseModels.InternationalLicense", b =>
                {
                    ...
                    b.HasOne("Models.ApplicationModels.InternationalDrivingLicenseApplication", "application")
                        .WithMany()
                        .HasForeignKey("applicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
