...
namespace DataConfigurations.Migrations
{
    ...
    [Migration("20250117002034_rename_CreatedByEmployee_to_CreatedByEmployeeId_In_Test_table")]
    partial class rename_CreatedByEmployee_to_CreatedByEmployeeId_In_Test_table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Users.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HiredDate = new DateTime(2025, 1, 17, 2, 20, 33, 228, DateTimeKind.Local).AddTicks(8805),
                            IsActive = true,
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            ...
                            HiredDate = new DateTime(2025, 1, 17, 2, 20, 33, 228, DateTimeKind.Local).AddTicks(8862),
                            IsActive = true,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            HiredByAdmin = new Guid("123e4567-e89b-12d3-a456-426614174000"),
                            HiredDate = new DateTime(2025, 1, 17, 2, 20, 33, 228, DateTimeKind.Local).AddTicks(8868),
                            IsActive = true,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        });
                });
