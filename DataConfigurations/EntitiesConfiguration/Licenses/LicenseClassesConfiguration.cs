...
namespace DataConfigurations.EntitiesConfiguration
{
    public class LicenseClassesConfiguration : IEntityTypeConfiguration<LicenseClass>
    {
        ...
        {
            builder.HasData(new LicenseClass
                {
                    LicenseClassId = (short)EnLicenseClasses.Private_Driver_License,
                    ClassName = "Private Driver License",
                    ClassDescription =
                        "Permits non-professional drivers to operate private vehicles, tourist taxis, agricultural tractors for personal use, and light transport vehicles up to 2000 kg",
                ...
                new LicenseClass
                {
                    ...
                    ClassDescription =
                        "For professional drivers to operate taxis and buses up to 17 passengers, in addition to all vehicles permitted under private license",
                ...
                new LicenseClass
                {
                    ...
                    ClassDescription =
                        "Permits operation of taxis, buses (17-26 passengers), transport vehicles, and heavy equipment. Requires 3 years experience with Third Class License",
                    MinimumAllowedAge = 21,
                    DefaultValidityLengthInMonths = 60,
                ...
                new LicenseClass
                {
                    ...
                    ClassDescription =
                        "Permits operation of all vehicle types. Requires 3 years experience with Second Class License",
                    MinimumAllowedAge = 21,
                    DefaultValidityLengthInMonths = 60,
                ...
                new LicenseClass
                {
                    ...
                    ClassDescription =
                        "Permits operation of military vehicles, issued exclusively to armed forces personnel",
                    MinimumAllowedAge = 21,
                    DefaultValidityLengthInMonths = 60,
